 ...
 * </p>
 * <ul>
 *   <li>{@link shelley.irish.purchaseOrder.model.purchaseOrder.impl.ItemImpl#getProductName <em>Product Name</em>}</li>
 *   <li>{@link shelley.irish.purchaseOrder.model.purchaseOrder.impl.ItemImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link shelley.irish.purchaseOrder.model.purchaseOrder.impl.ItemImpl#getUSPrice <em>US Price</em>}</li>
 *   <li>{@link shelley.irish.purchaseOrder.model.purchaseOrder.impl.ItemImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link shelley.irish.purchaseOrder.model.purchaseOrder.impl.ItemImpl#getShipDate <em>Ship Date</em>}</li>
 *   <li>{@link shelley.irish.purchaseOrder.model.purchaseOrder.impl.ItemImpl#getPartNum <em>Part Num</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ItemImpl extends MinimalEObjectImpl.Container implements Item {
	...
	public void setUSPrice(int newUSPrice) {
		...
		usPrice = newUSPrice;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PurchaseOrderPackage.ITEM__US_PRICE, oldUSPrice,
					usPrice));
	}
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PurchaseOrderPackage.ITEM__COMMENT, oldComment,
					comment));
	}
	...
	public void setShipDate(Date newShipDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PurchaseOrderPackage.ITEM__SHIP_DATE, oldShipDate,
					shipDate));
	}
	...
	public void setPartNum(String newPartNum) {
		...
		partNum = newPartNum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PurchaseOrderPackage.ITEM__PART_NUM, oldPartNum,
					partNum));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case PurchaseOrderPackage.ITEM__QUANTITY:
			return getQuantity();
		case PurchaseOrderPackage.ITEM__US_PRICE:
			return getUSPrice();
		case PurchaseOrderPackage.ITEM__COMMENT:
			return getComment();
		case PurchaseOrderPackage.ITEM__SHIP_DATE:
			return getShipDate();
		case PurchaseOrderPackage.ITEM__PART_NUM:
			return getPartNum();
		}
